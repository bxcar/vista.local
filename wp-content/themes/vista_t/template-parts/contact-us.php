    ...
    <div class="l-innerContent">
        <div class="contactUs-inner">
            <div class="mainwrap">
                ...
                <form class="contactUs-form form-general">
                    <p class="contactUs-form-description"><?php the_field('text_under_cf_title'); ?></p>
                    <input type="text" placeholder="<?php the_field('cf_field_1'); ?>" required>
                    <input type="email" placeholder="<?php the_field('cf_field_2'); ?>" required>
                    <input type="number" placeholder="<?php the_field('cf_field_3'); ?>">
                    <input type="text" placeholder="<?php the_field('cf_field_4'); ?>">
                    <textarea placeholder="<?php the_field('cf_field_5'); ?>"></textarea>
                    <button class="btn-general filled orange" type="submit"><?php the_field('cf_button_text'); ?></button>
                </form>
